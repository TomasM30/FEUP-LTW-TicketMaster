...
<html>
    ...
    <body>
        ...
        <br>
        <p><?php if ($_GET['error'] == 1){echo "Username is already in use, please use another one";} 
                elseif ($_GET['error'] == 2) {echo "Email is already in use, please use another one";}
                elseif ($_GET['error'] == 3) {echo "Passwords do not match, please try again";}
                ?></p>
